...
const REDIRECT_URI = 'exp://2w-qgt.anonymous.pokedex-app.exp.direct:80';
    ...
    async function autenticarComIAS(){
       try {
            ...
            let result = await WebBrowser.openAuthSessionAsync(
                `${URL_ACESSO_IAS}/authorize?client_id=${CLIENT_ID}&redirect_uri=${REDIRECT_URI}&response_type=${RESPONSE_TYPE}`
                , REDIRECT_URI
            )
            ...
            if(result.type === 'success'){
                ...
                const code = redirectData.queryParams["code"];
